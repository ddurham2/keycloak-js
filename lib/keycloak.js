...
// TODO cordova seems to remember if it's opened or completed something ... see if that logic was not present when this capacitor impl was original conceived because we may want to employ it here too
// TODO also it remembers a reference to the tab it originally opened and only closes it when we close
// TODO also there are these cordovaOptions that it builds for opening the browser tab and we could reuse that
                        window.cordova.plugins.browsertab.close();
